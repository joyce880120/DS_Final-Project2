...
<div class="topnav">
	<a href="http://localhost:8080/DS_HTML/googleitem.jsp">全部</a><a
		...
		class="active" href="http://localhost:8080/DS_HTML/video.jsp">影片</a> <a
...
<body>
	<video src="video/ds_demo.webm" type="video/webm" width=60%
		style="display: block; margin: auto;" controls>
	</video>
</body>
<br>
<br>
